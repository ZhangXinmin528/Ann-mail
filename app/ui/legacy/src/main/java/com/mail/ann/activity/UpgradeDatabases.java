...
import com.mail.ann.service.DatabaseUpgradeService;
 ...
 * the locking in {@link com.mail.ann.mailstore.LocalStoreProvider#getInstance(Account)} the upgrade service will block
 ...
 * </p>
 */
public class UpgradeDatabases extends AnnActivity {
