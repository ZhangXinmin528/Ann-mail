...
import com.mail.ann.autodiscovery.providersxml.ProvidersXmlDiscovery
import com.mail.ann.helper.SimpleTextWatcher
import com.mail.ann.helper.Utility.requiredFieldValid
...
import com.mail.ann.ui.getEnum
 ...
 * 创建新账户
 */
class AccountSetupBasics : AnnActivity() {
