...
import com.mail.ann.activity.compose.AttachmentPresenter.AttachmentsChangedListener
...
import com.mail.ann.mailstore.LocalBodyPart
...
class AttachmentPresenterTest : K9RobolectricTest() {
    ...
    fun loadNonInlineAttachments_normalAttachment() {
        ...
        assertThat(attachment?.state).isEqualTo(com.mail.ann.message.Attachment.LoadingState.COMPLETE)
